...
# Notifications to the instructor about adding them to the database
...
def task(task_id):
    ...
    return render_template("./website_pages/task.html", task=task, task_content=task_content, additional_styles=html_formatter.get_style_defs())
# ========================
...
# ========================
def generate_and_save_heatmap(heatmap, width, height):
    ...
    flash("Report generated successfully and saved as static/media/heatmap.png")
# ========================
...
def generate_heatmap_individual():
    ...
    # Saving the heatmap
    generate_and_save_heatmap(heatmap, width, height)
